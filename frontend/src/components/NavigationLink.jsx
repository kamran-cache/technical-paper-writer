...
const Navigationlink = () => {
  ...
  return (
    <div className="pdf-viewer w-full h-screen flex flex-col">
          ...
          <div className="flex items-center justify-center w-full h-screen">
            <iframe
              ...
              style={{
                ...
                height: "80%", // Adjust the height for better proportion
                transform: `scale(${zoom})`,
                transformOrigin: "center center", // Ensures zoom happens from the center
                border: "none",
